...
export const ReviseIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
...
export const FlipHorizontalIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 8l4 4-4 4" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M20 8l-4 4 4 4" />
    </svg>
);
